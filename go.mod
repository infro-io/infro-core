...
require (
	...
	k8s.io/cluster-bootstrap v0.24.17
	k8s.io/controller-manager v0.24.17
	k8s.io/cri-api v0.24.17
	k8s.io/csi-translation-lib v0.24.17
	k8s.io/kube-controller-manager v0.24.17
	k8s.io/kube-proxy v0.24.17
	k8s.io/kube-scheduler v0.24.17
	k8s.io/kubelet v0.24.17
	k8s.io/legacy-cloud-providers v0.24.17
	k8s.io/mount-utils v0.24.17
	k8s.io/pod-security-admission v0.24.17
	k8s.io/sample-apiserver v0.24.17
